...
app.get('/personalBudget/names', async (req, res) => {
...
//get all envelopes
app.get('/personalBudget', async (req, res, next) => {
...
//create new envelope
app.post('/personalBudget', async (req, res, next) => {
...
app.post('/personalBudget/:from/:to', async (req, res, next) => {
...
app.put('/personalBudget/:envName/withdraw', async (req, res, next) => {
...
//delete envelope
app.delete('/personalBudget/:envName', async (req, res, next) => {
